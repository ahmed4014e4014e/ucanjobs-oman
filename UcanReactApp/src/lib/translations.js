...
export const translations = {
  en: {
    ...
    tutorApplicationPage: {
      ...
      heroText:
        "Complete this form with your university details, desired courses, and supporting documents so the platform can review your instructor application properly.",
      heroCardText:
        "Instructor applications are reviewed using your academic information and required supporting documents.",
      ...
      desiredCourses: "Desired Courses",
      courseNote: "Please highlight course code (for example: CPT 220)",
      coursePlaceholder: "List the courses you want to teach as an instructor.",
      ...
      attachments: [
        "Academic transcript proving a minimum grade of B+ in the selected course(s) you want to teach",
      ...
      messages: {
        ...
        files: "Please attach the required supporting documents before submitting your instructor application.",
        success:
        ...
        desired: "Desired courses: {courses}",
      },
    },
    records: {
      unknown: "Unknown",
  ...
  ar: {
    ...
    tutorApplicationPage: {
      ...
      heroCardText:
        "تتم مراجعة طلبات المدربين باستخدام معلوماتك الأكاديمية والمستندات الداعمة المطلوبة.",
      ...
      coursePlaceholder: "اكتب المقررات التي تريد أن تصبح مدرباً فيها.",
      ...
      messages: {
        ...
        files: "يرجى إرفاق المستندات الداعمة المطلوبة قبل إرسال طلب المدرب.",
        success:
